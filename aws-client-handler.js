...
class AwsClientHandler {
  ...
  userUpdateItem(userUpdateString) {
 ...
 adminPutItem(formState) {
  ...
  executeUserUpdateItem1(userUpdateItemInput){
  ...
  executeAdminUpdateItem1(adminUpdateItemInput) {
    var dynamoDbClient = this.dynamoDbClient
  ...
  executePutItem1(adminPutItemInput) {
    var dynamoDbClient = this.dynamoDbClient
  ...
  createUserUpdateItemInput(userResponseString) {
    return {
      "TableName": "SeniorDesignLab3DB",
      "Key": {
        "UniqueTitle": {
  ...
  createAdminUpdateItemInput(formState) {
  ...
  createAdminPutItemInput(formState) {
