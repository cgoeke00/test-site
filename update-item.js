...
// Create the input for updateItem call
const updateItemInput = createUpdateItemInput();
...
function createUpdateItemInput() {
  return {
    ...
    "ExpressionAttributeValues": {
      ":083d0": {
        "SS": [
          "This is an example of a response for Liam's New Poll. It is a string now, but should be a dictionary later."
        ]
      }
    },
